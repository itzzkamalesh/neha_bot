...
PICS = (environ.get('PICS', 'https://graph.org/file/e48ab4ba0593f1a3b35bf.png')).split()#SAMPLE PIC
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002034717675')).split()]
...
URL = "https://conventional-antonella-autocool-8a15ab68.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://conventional-antonella-autocool-8a15ab68.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://conventional-antonella-autocool-8a15ab68.koyeb.app/".format(FQDN)
else:
    URL = "https://conventional-antonella-autocool-8a15ab68.koyeb.app/".format(FQDN)
