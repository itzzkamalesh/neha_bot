...
URL = "https://psychiatric-ethelyn-autocool-1bd26e5f.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://psychiatric-ethelyn-autocool-1bd26e5f.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://psychiatric-ethelyn-autocool-1bd26e5f.koyeb.app/".format(FQDN)
else:
    URL = "https://psychiatric-ethelyn-autocool-1bd26e5f.koyeb.app/".format(FQDN)
